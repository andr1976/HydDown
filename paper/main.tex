...
identified above, but its reference thermodynamic backend \citep{Span1996} is not defined below the
triple point and has no solid phase, so it can neither integrate a discharge isentrope through a
sub-triple throat nor account for dry-ice formation. Extending HydDown to the intermediate- and
transport-pressure CO$_2$ regime is therefore a logical next step. The purpose of the present
paper is to present such an extension and its validation. The specific objectives are to:
\begin{enumerate}
  \item describe a thermopack-free treatment of sub-triple CO$_2$ thermodynamics, combining
        imposed-phase evaluation of the fluid equation of state with a precomputed solid-CO$_2$
        property table;
  \item describe the associated discharge, dry-ice and heat-transfer models for both
        vapour-space and liquid-space releases; and
