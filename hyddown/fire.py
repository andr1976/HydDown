...
def stefan_boltzmann(alpha, e_flame, e_surface, h, Tflame, Tradiative, Tvessel):
    ...
    return alpha * e_flame * sigma * Tradiative**4 + h * (Tflame - Tvessel) - e_surface * sigma * Tvessel**4
...
if __name__ == "__main__":
    ...
    Tflame = 635 + 273.15
    Tradiative = 635 + 273.15
    print(stefan_boltzmann(alpha, e_flame, e_surface, h, Tflame, Tradiative, 20+273.15))
