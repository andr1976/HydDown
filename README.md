...
Consult the [manual](https://andr1976.github.io/HydDown/) for a more rigorous explanation of the software, the implemented methods, and its usage. Further, the manual also contains a few validation studies. 
...
- Applied by the engineering consultancy Fichtner for the [HYDESS (Hydrogen for the Decarbonisation of Sheffield Steel) project for E.ON](https://assets.publishing.service.gov.uk/media/6913275c1fcc92b3f349635b/HYDESS-project-hydrogen-for-the-decarbonisation-of-Sheffield-steel.pdf). HydDown was used for calculating vent rates. 
