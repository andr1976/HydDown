...
st.markdown(
    ...
    **👈 Select a demo from the sidebar** to see some examples
    ...
    - 1-D transient heat transfer models for vessel wall including dual layer wallls for modelling e.g. composite vessels or insulated vessels
    ...
    - Vessel rupture calculations based on von Misses stress criteria according to Scandpower guidelines. 
