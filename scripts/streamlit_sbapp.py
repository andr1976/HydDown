    ...
    with sideb:
        ...
        with st.form(key="my_form"):
            ...
            with c1:
                ...
                fire_type = st.selectbox("Fire type", ("api_jet", "api_pool"))
...
if __name__ == "__main__":
    ...
    heat_data = pd.DataFrame(
        {
            "Time (s)": hdown.time_array,
            "Outside heat flux (W / m2)": hdown.Q_outer / hdown.surf_area_outer,
            "Inside heat flux (W / m2)": hdown.Q_inner / hdown.surf_area_inner,
        }
    )
